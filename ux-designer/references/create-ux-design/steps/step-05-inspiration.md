...
- For 'A': perform the advanced clarification pass on the current inspiration analysis content and apply edits directly.
...
- For 'P': perform the multi-perspective pass on the current inspiration analysis and apply edits directly.
...
- Read fully and follow: `references/create-ux-design/steps/step-06-design-system.md`
...
After user selects 'C' and content is saved to document, load `references/create-ux-design/steps/step-06-design-system.md` to choose the appropriate design system approach.

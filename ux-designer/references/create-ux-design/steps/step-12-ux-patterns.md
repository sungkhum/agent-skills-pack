...
- For 'A': perform the advanced clarification pass on the current UX patterns content and apply edits directly.
...
- For 'P': perform the multi-perspective pass on the current UX patterns and apply edits directly.
...
- Load `references/create-ux-design/steps/step-13-responsive-accessibility.md`
...
After user selects 'C' and content is saved to document, load `references/create-ux-design/steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.

...
- For 'A': perform the advanced clarification pass on the current responsive/accessibility content and apply edits directly.
...
- For 'P': perform the multi-perspective pass on the current responsive/accessibility strategy and apply edits directly.
...
- Load `references/create-ux-design/steps/step-14-complete.md`
...
After user selects 'C' and content is saved to document, load `references/create-ux-design/steps/step-14-complete.md` to finalize the UX design workflow.

...
- For 'A': perform the advanced clarification pass on the current design system content and apply edits directly.
...
- For 'P': perform the multi-perspective pass on the current design system choice and apply edits directly.
...
- Load `references/create-ux-design/steps/step-07-defining-experience.md`
...
After user selects 'C' and content is saved to document, load `references/create-ux-design/steps/step-07-defining-experience.md` to define the core user interaction.

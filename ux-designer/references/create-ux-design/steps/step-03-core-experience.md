...
- For 'A': perform the advanced clarification pass on the current core experience content and apply edits directly.
...
- For 'P': perform the multi-perspective pass on the current core experience definition and apply edits directly.
...
- Load `references/create-ux-design/steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `references/create-ux-design/steps/step-04-emotional-response.md` to define desired emotional responses.

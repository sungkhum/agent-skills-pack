...
- For 'A': perform the advanced clarification pass on the current defining experience content and apply edits directly.
...
- For 'P': perform the multi-perspective pass on the current defining experience and apply edits directly.
...
- Load `references/create-ux-design/steps/step-08-visual-foundation.md`
...
After user selects 'C' and content is saved to document, load `references/create-ux-design/steps/step-08-visual-foundation.md` to establish visual design foundation.

...
- Load: `references/domain-steps/step-02-domain-analysis.md`
...
After user selects 'C', load `references/domain-steps/step-02-domain-analysis.md` to begin industry analysis.

...
- Load: `references/market-steps/step-04-customer-decisions.md`
...
After user selects 'C', load `references/market-steps/step-04-customer-decisions.md` to analyze customer decision processes, journey mapping, and decision factors for {{research_topic}}.

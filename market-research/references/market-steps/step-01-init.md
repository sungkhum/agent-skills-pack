...
- Load: `references/market-steps/step-02-customer-behavior.md`
...
After user confirmation and scope finalization, load `references/market-steps/step-02-customer-behavior.md` to begin detailed market research with customer insights analysis.

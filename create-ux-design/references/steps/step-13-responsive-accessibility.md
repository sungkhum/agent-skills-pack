...
- Load `references/steps/step-14-complete.md`
...
After user selects 'C' and content is saved to document, load `references/steps/step-14-complete.md` to finalize the UX design workflow.
